...
// #include "ZShape.h"
// #include "ZRectangularPrism.h"
// #include <algorithm>
// #include <iostream>
// unsigned int ZRectangularPrism::getNumVertices() {
//     return 8;
// }
// unsigned int ZRectangularPrism::getNumIndices() {
//     return 36;
// }
// void ZRectangularPrism::appendVertexData(float* vertexData, unsigned int index) {
//     glm::mat4 matrix = ZShape::getMatrix();
...
// }
// void ZRectangularPrism::appendIndexData(unsigned int* indexData, unsigned int index, unsigned int firstPoint) {
...
// }
// ZRectangularPrism::ZRectangularPrism(bool isStatic, float x, float y, float z, float pitch, float yaw, float roll, float xScale, float yScale, float zScale) {
